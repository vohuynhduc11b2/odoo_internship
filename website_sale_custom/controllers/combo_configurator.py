...
class WebsiteSaleComboConfiguratorController(SaleComboConfiguratorController, WebsiteSale):
    ...
    @route(
        route='/website_sale_custom/combo_configurator/get_data',
        type='json',
        auth='public',
        website=True,
    )
    def website_sale_combo_configurator_get_data(self, *args, **kwargs):
        ...
        is_quantity_view_enabled = request.website.is_view_active('website_sale_custom.product_quantity')
        res.update({
            'show_quantity': (
    ...
    @route(
        route='/website_sale_custom/combo_configurator/get_price',
        type='json',
        auth='public',
        website=True,
    )
    ...
    @route(
        route='/website_sale_custom/combo_configurator/update_cart',
        type='json',
        auth='public',
        methods=['POST'],
        website=True,
    ...
    def website_sale_combo_configurator_update_cart(
        ...
        combo_quantity, warning = order_sudo._verify_updated_quantity(
            request.env['sale_custom.order.line'], combo_product_id, quantity, **kwargs
        )
        ...
        for combo_item in selected_combo_items:
            combo_item_quantity, warning = order_sudo._verify_updated_quantity(
                request.env['sale_custom.order.line'], combo_item['product_id'], quantity, **kwargs
            )
        ...
        combo_product_line = request.env['sale_custom.order.line'].browse(values['line_id'])
        if (
            combo_product_line

...
class Delivery(WebsiteSale):
    ...
    def shop_delivery_methods(self):
        ...
        return request.env['ir.ui.view']._render_template('website_sale_custom.delivery_form', values)

    def _get_additional_delivery_context(self):
        """ Hook to update values used for rendering the website_sale_custom.delivery_form template. """
        return {}
    ...
    def _order_summary_values(self, order, **kwargs):
        ...
        :param sale_custom.order order: The sales order whose summary values to return.
    ...
    @route('/website_sale_custom/set_pickup_location', type='json', auth='public', website=True)
    ...
    @route('/website_sale_custom/get_pickup_locations', type='json', auth='public', website=True)
    ...
    def _get_delivery_methods_express_checkout(cls, order_sudo):
        ...
        :param sale_custom.order order_sudo: The sudoed sales order.
        :rtype: dict
    ...
    def _get_rate(delivery_method, order, is_express_checkout_flow=False):
        ...
        :param delivery.carrier delivery_method: The delivery method for which the rate must be
                                                 computed.
        :param sale_custom.order order: The current sales order.

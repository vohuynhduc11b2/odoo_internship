...
class WebsiteSaleProductConfiguratorController(SaleProductConfiguratorController, WebsiteSale):
    ...
    @route(
        route='/website_sale_custom/should_show_product_configurator',
        type='json',
        auth='public',
        website=True,
    )
    ...
    @route(
        route='/website_sale_custom/product_configurator/get_values',
        type='json',
        auth='public',
        website=True,
    )
    ...
    @route(
        route='/website_sale_custom/product_configurator/create_product',
        type='json',
        auth='public',
        methods=['POST'],
        website=True,
    ...
    @route(
        route='/website_sale_custom/product_configurator/update_combination',
        type='json',
        auth='public',
        methods=['POST'],
        website=True,
    ...
    @route(
        route='/website_sale_custom/product_configurator/get_optional_products',
        type='json',
        auth='public',
        website=True,
    )
    ...
    @route(
        route='/website_sale_custom/product_configurator/update_cart',
        type='json',
        auth='public',
        methods=['POST'],
        website=True,
    ...
    def _get_basic_product_information(
        ...
        :param datetime|None date: The date of the `sale_custom.order`, to compute the price at the right
            rate.
    ...
    def _get_strikethrough_price(self, product_or_template, currency, date, price, pricelist_rule_id=None):
        ...
        if (
            request.env.user.has_group('website_sale_custom.group_product_price_comparison')

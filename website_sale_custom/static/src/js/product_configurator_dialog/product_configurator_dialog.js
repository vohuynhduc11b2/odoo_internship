...
patch(ProductConfiguratorDialog.prototype, {
    setup() {
        ...
        if (this.props.isFrontend) {
            this.getValuesUrl = '/website_sale_custom/product_configurator/get_values';
            this.createProductUrl = '/website_sale_custom/product_configurator/create_product';
            this.updateCombinationUrl = '/website_sale_custom/product_configurator/update_combination';
            this.getOptionalProductsUrl = '/website_sale_custom/product_configurator/get_optional_products';

...
import websiteConfiguratorTourUtils from '@website_sale_custom/js/tours/product_configurator_tour_utils';
import * as wsTourUtils from '@website_sale_custom/js/tours/tour_utils';

...
import * as tourUtils from "@website_sale_custom/js/tours/tour_utils";

odoo.loader.bus.addEventListener("module-started", (e) => {
    if (e.detail.moduleName === "@website_sale_custom/js/website_sale_tracking") {
        //import websiteSaleTracking from "@website_sale_custom/js/website_sale_tracking";

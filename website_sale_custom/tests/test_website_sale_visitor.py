...
class WebsiteSaleVisitorTests(TransactionCase):
    ...
    def test_dynamic_filter_newest_products(self):
        ...
        snippet_filter = self.env.ref('website_sale_custom.dynamic_filter_newest_products')
    ...
    def test_recently_viewed_company_changed(self):
        ...
        snippet_filter = self.env.ref('website_sale_custom.dynamic_filter_latest_viewed_products')

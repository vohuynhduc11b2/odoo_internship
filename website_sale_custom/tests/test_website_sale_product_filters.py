...
class TestWebsiteSaleProductFilters(WebsiteSaleCommon, TestSaleProductAttributeValueCommon):
    ...
    def test_latest_sold_filter(self):
        ...
        dyn_filter = self.env.ref('website_sale_custom.dynamic_filter_latest_sold_products')
    ...
    def test_latest_viewed_filter(self):
        ...
        dyn_filter = self.env.ref('website_sale_custom.dynamic_filter_latest_viewed_products')
        with MockRequest(self.env, website=self.website):
    ...
    def test_recently_sold_with_filter(self):
        ...
        dyn_filter = self.env.ref('website_sale_custom.dynamic_filter_cross_selling_recently_sold_with')
        with MockRequest(self.env, website=self.website):
            with_variants = self.WebsiteSnippetFilter.with_context(
                dynamic_filter=dyn_filter,
                hide_variants=False,
    ...
    def test_accessories_filter(self):
        ...
        """
        dyn_filter = self.env.ref('website_sale_custom.dynamic_filter_cross_selling_accessories')
        with MockRequest(self.env, website=self.website):
            with_variants = self.WebsiteSnippetFilter.with_context(
                dynamic_filter=dyn_filter,
                hide_variants=False,
    ...
    def test_alternative_products_filter(self):
        ...
        """
        dyn_filter = self.env.ref('website_sale_custom.dynamic_filter_cross_selling_alternative_products')
        with MockRequest(self.env, website=self.website):
            with_variants = self.WebsiteSnippetFilter.with_context(
                dynamic_filter=dyn_filter,
                hide_variants=False,
    ...
    def test_newest_products_filter(self):
        ...
        dyn_filter = self.env.ref('website_sale_custom.dynamic_filter_newest_products')
        with MockRequest(self.env, website=self.website):

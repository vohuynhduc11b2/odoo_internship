...
class TestSaleOrderCreditLimit(TestSaleCommon):
    ...
    def setUpClass(cls):
        ...
        cls.empty_order = cls.env['sale_custom.order'].create({
    ...
    def test_credit_limit_multi_company(self):
        ...
        sale_order = company2.env['sale_custom.order'].create({
    ...
    def test_warning_on_invoice_with_downpayment(self):
        ...
        self.env['sale_custom.advance.payment.inv'].with_context({
        ...
        credit_note = sale_order_custom.invoice_ids[1]
        credit_note.action_post()

        # Check that the credit note is accounted for correctly for the amount_to_invoice
        self.assertEqual(sale_order_custom.amount_to_invoice, sale_order_custom.amount_total)
    ...
    def test_credit_limit_and_warning_overinvoiced_sales_order(self):
        ...
        sale_orders = self.env['sale_custom.order'].create(
            [sale_order_values] * 2
        )
        ...
        self.assertEqual(sale_order_custom.amount_to_invoice, 1000.0)

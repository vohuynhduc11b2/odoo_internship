...
class TestAccruedSaleOrders(AccountTestInvoicingCommon):
    ...
    def setUpClass(cls):
        ...
        cls.sale_order = cls.env['sale_custom.order'].with_context(tracking_disable=True).create({
        ...
        cls.wizard = cls.env['account.accrued.orders.wizard'].with_context({
            ...
            'active_ids': cls.sale_order_custom.ids,
        }).create({
    ...
    def test_accrued_order(self):
        ...
        self.sale_order_custom.order_line.qty_delivered = 5
        ...
        invoices = self.sale_order_custom._create_invoices()
    ...
    def test_multi_currency_accrued_order(self):
        ...
        self.sale_order_custom.order_line.qty_delivered = 5
        # self.sale_order_custom.order_line.product_uom_qty = 5
        # set currency != company currency
        self.sale_order_custom.currency_id = self.other_currency
        self.assertRecordValues(self.env['account.move'].search(self.wizard.create_entries()['domain']).line_ids, [
            # reverse move lines
    ...
    def test_analytic_account_accrued_order(self):
        self.sale_order_custom.order_line.qty_delivered = 10
    ...
    def test_product_name_in_accrued_revenue_entry(self):
        ...
        so_context = {
            'active_model': 'sale_custom.order',
            'active_ids': self.sale_order_custom.ids,

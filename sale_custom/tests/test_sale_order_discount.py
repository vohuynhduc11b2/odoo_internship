...
class TestSaleOrderDiscount(SaleCommon):
    ...
    def setUpClass(cls):
        super().setUpClass()
        cls.wizard = cls.env['sale_custom.order.discount'].create({
            'sale_order_id': cls.sale_order_custom.id,
    ...
    def test_amount(self):
        ...
        discount_line = self.sale_order_custom.order_line[-1]
    ...
    def test_amount_discount_with_fixed_tax(self):
        solines = self.sale_order_custom.order_line
        ...
        discount_line = self.sale_order_custom.order_line - solines
    ...
    def test_so_discount(self):
        solines = self.sale_order_custom.order_line
        amount_before_discount = self.sale_order_custom.amount_total
        self.assertEqual(len(solines), 2)
        ...
        self.wizard.action_apply_discount()
        discount_lines = self.sale_order_custom.order_line - solines
    ...
    def test_sol_discount(self):
        so_amount = self.sale_order_custom.amount_untaxed
        self.wizard.write({
            'discount_percentage': 0.5,  # 50%
        ...
        self.assertTrue(
            all(line.discount == 50 for line in self.sale_order_custom.order_line)
        )
        self.assertAlmostEqual(self.sale_order_custom.amount_untaxed, so_amount*0.5)
        ...
        self.assertAlmostEqual(self.sale_order_custom.amount_untaxed, so_amount*1.5)
    ...
    def test_sol_discount_removal(self):
        ...
        self.assertFalse(self.sale_order_custom.order_line.filtered('discount'))
        self.assertAlmostEqual(self.sale_order_custom.amount_untaxed, so_amount)
    ...
    def test_discount_translation_tax_groups(self):
        ...
        self.wizard.action_apply_discount()
        self.assertEqual(
            self.sale_order_custom.order_line[-2].name,
            "Descontar 10.00% - en los productos con los siguientes impuestos 10% VAT",
        )
        self.assertEqual(
            self.sale_order_custom.order_line[-1].name,
            "Descontar 10.00% - en los productos con los siguientes impuestos 20% VAT",
        )

    def test_line_and_global_discount(self):
        solines = self.sale_order_custom.order_line
        amount_before_discount = self.sale_order_custom.amount_untaxed
        self.assertEqual(len(solines), 2)

        solines.discount = 10
        self.assertEqual(self.sale_order_custom.amount_untaxed, amount_before_discount * 0.9)
        amount_with_line_discount = self.sale_order_custom.amount_untaxed
        ...
        self.wizard.action_apply_discount()
        self.assertEqual(self.sale_order_custom.amount_untaxed, amount_with_line_discount * 0.9)

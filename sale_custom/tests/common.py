...
class SaleCommon(
    ...
    def setUpClass(cls):
        ...
        cls.group_discount_per_so_line = cls.env.ref('sale_custom.group_discount_per_so_line')
...
class TestTaxCommonSale(TestTaxCommon):
    ...
    def assert_sale_order_tax_totals_summary(self, sale_order, expected_values, soft_checking=False):
        self._assert_tax_totals_summary(sale_order_custom.tax_totals, expected_values, soft_checking=soft_checking)
        cash_rounding_base_amount_currency = sale_order_custom.tax_totals.get('cash_rounding_base_amount_currency', 0.0)

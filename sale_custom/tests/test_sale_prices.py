...
class TestSalePrices(SaleCommon):
    ...
    def test_pricelist_dates(self):
        ...
        with freeze_time(today):
            ...
            order_line = self.env['sale_custom.order.line'].create({
    ...
    def test_no_pricelist_rules(self):
        ...
        with freeze_time('2022-08-19'):
            ...
            order_in_other_currency = self.env['sale_custom.order'].create({
    ...
    def test_multi_currency_discount(self):
        ...
        sales_order = product_1_ctxt.with_context(mail_notrack=True, mail_create_nolog=True).env['sale_custom.order'].create({
    ...
    def test_update_prices(self):
        ...
        so_amount = sale_order_custom.amount_total
        start_so_amount = so_amount
        sale_order_custom._recompute_prices()
        self.assertEqual(
            sale_order_custom.amount_total, so_amount,
            "Updating the prices of an unmodified SO shouldn't modify the amounts")

        pricelist = sale_order_custom.pricelist_id
        pricelist.item_ids = [
            Command.create({
                'percent_price': 5.0,
                'compute_price': 'percentage'
        ...
        self.assertTrue(all(line.discount == 5 for line in sale_order_custom.order_line))
        self.assertEqual(sale_order_custom.amount_undiscounted, so_amount)
        self.assertEqual(sale_order_custom.amount_total, 0.95*so_amount)
        ...
        self.assertTrue(all(line.discount == 0 for line in sale_order_custom.order_line))
        self.assertEqual(sale_order_custom.amount_undiscounted, so_amount)
        self.assertEqual(sale_order_custom.amount_total, 0.95*so_amount)

        # Test taking off the pricelist
        sale_order_custom.pricelist_id = False
        sale_order_custom._recompute_prices()

        self.assertTrue(all(line.discount == 0 for line in sale_order_custom.order_line))
        self.assertEqual(sale_order_custom.amount_undiscounted, so_amount)
        self.assertEqual(
            sale_order_custom.amount_total, start_so_amount,
    ...
    def test_manual_price_prevents_recompute(self):
        sale_order_line = self.sale_order_custom.order_line[0]
        # Ensure initial price is set correctly
        self.assertEqual(sale_order_line_custom.price_unit, 20.0)
        ...
        self.assertEqual(
            sale_order_line_custom.price_unit, 100.0,
        ...
        so_line = self.env['sale_custom.order.line'].create({
    ...
    def test_fiscalposition_application(self):
        ...
        SaleOrder = self.env['sale_custom.order']
        ...
        self.assertRecordValues(sale_order_custom.order_line, [{'price_unit': 106, 'price_subtotal': 100}])
        ...
        with order_form.order_line.new() as line:
            ...
            line.product_uom_qty = 1.0
        sale_order = order_form.save()
        self.assertRecordValues(sale_order_custom.order_line, [{'price_unit': 100, 'price_subtotal': 94.34}])
        ...
        with order_form.order_line.new() as line:
            ...
            line.product_uom_qty = 1.0
        sale_order = order_form.save()
        self.assertRecordValues(sale_order_custom.order_line, [{'price_unit': 100, 'price_subtotal': 100}])
        ...
        with order_form.order_line.new() as line:
            ...
            line.product_uom_qty = 1.0
        sale_order = order_form.save()
        self.assertRecordValues(sale_order_custom.order_line, [{'price_unit': 100, 'price_subtotal': 84.91}])
    ...
    def test_sale_with_taxes(self):
        ...
        self.sale_order_custom.order_line[0].write({'tax_id': [Command.link(tax_include.id)]})
        self.sale_order_custom.order_line[1].write({'tax_id': [Command.link(tax_exclude.id)]})
        ...
        self.assertAlmostEqual(
            self.sale_order_custom.amount_total,
            self.sale_order_custom.amount_untaxed + self.sale_order_custom.amount_tax,
            places=2)
    ...
    def test_show_discount(self):
        ...
        self.assertEqual(200, sale_order_custom.amount_total)
        ...
        sale_order_custom.pricelist_id = base_discount_pricelist
        sale_order_custom._recompute_prices()
        show_discount_line = sale_order_custom.order_line[0]
        included_discount_line = sale_order_custom.order_line[1]
        ...
        sale_order_custom.pricelist_id = discount_pricelist
        sale_order_custom._recompute_prices()

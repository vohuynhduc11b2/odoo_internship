...
class SaleAdvancePaymentInv(models.TransientModel):
    _name = 'sale_custom.advance.payment.inv'
    ...
    sale_order_ids = fields.Many2many(
        'sale_custom.order', default=lambda self: self.env.context.get('active_ids'))
    ...
    def _create_invoices(self, sale_orders):
        ...
        if self.advance_payment_method == 'delivered':
            ...
            SaleOrderline = self.env['sale_custom.order.line'].with_context(sale_no_log_for_new_lines=True)

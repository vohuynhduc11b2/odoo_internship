...
class SaleProductConfiguratorController(Controller):
    ...
    def sale_product_configurator_get_values(
        ...
        **kwargs,
        ...
        :param str so_date: The date of the `sale_custom.order`, to compute the price at the right rate.
    ...
    def _get_product_information(
        ...
        **kwargs,
        ...
        :param datetime so_date: The date of the `sale_custom.order`, to compute the price at the right
            rate.
        :param int quantity: The quantity of the product.
        :param int|None product_uom_id: The unit of measure of the product, as a `uom.uom` id.

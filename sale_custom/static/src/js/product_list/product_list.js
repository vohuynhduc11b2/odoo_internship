...
export class ProductList extends Component {
    ...
    static template = "sale_custom.ProductList";
    static props = {
        products: Array,
    ...
    /**
     * Return the total of the product in the list, in the currency of the `sale_custom.order`.
     *
     * @return {String} - The sum of all items in the list, in the currency of the `sale_custom.order`.
     */
    getFormattedTotal() {

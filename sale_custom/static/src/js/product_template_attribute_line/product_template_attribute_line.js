...
export class ProductTemplateAttributeLine extends Component {
    ...
    static template = "sale_custom.ProductTemplateAttributeLine";
    static props = {
    ...
    getPTAVTemplate() {
        switch(this.props.attribute.display_type) {
            case 'select':
                return 'sale_custom.ptav_select';
            case 'radio':
                return 'sale_custom.ptav_radio';
            case 'pills':
                return 'sale_custom.ptav_pills';
            case 'color':
                return 'sale_custom.ptav_color';
            case 'multi':
                return 'sale_custom.ptav_multi';
        }
    }

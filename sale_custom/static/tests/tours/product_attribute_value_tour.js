...
const openProductAttribute = (product_attribute) => [
    ...stepUtils.goToAppSteps("sale_custom.sale_menu_root", "Go to the Sales App"),
    {
        content: 'Open configuration menu',
        trigger: '.o-dropdown[data-menu-xmlid="sale_custom.menu_sale_config"]',
        run: "click",
    },
    {
        content: 'Navigate to product attribute list view',
        trigger: '.o-dropdown-item[data-menu-xmlid="sale_custom.menu_product_attribute_action"]',
        run: "click",
    },
    {
